...
Namespace Migrations
    ...
    Public NotInheritable Partial Class TraitsChanges
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(TraitsChanges))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201512210404355_TraitsChanges"
            End Get
        End Property
