...
Namespace Migrations
    ...
    Public NotInheritable Partial Class RegisterChanges
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RegisterChanges))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201512210532566_RegisterChanges"
            End Get
        End Property
