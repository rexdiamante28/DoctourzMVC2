...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AffiliationChanges
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AffiliationChanges))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201512210216097_AffiliationChanges"
            End Get
        End Property
