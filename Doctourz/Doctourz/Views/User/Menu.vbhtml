...
<div class="navbar-default sidebar sidebar-close" id="sidebar" role="navigation" onmouseover="UnfoldSideBar()">
    <div class="sidebar-nav navbar-collapse">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li id="sidelink8" onclick="SidebarChildDecide(this.id)" ><i class="fa fa-file-text-o"></i>Topics</li>
            <li id="sidelink9" onclick="SidebarChildDecide(this.id)" ><i class="fa fa-user-plus"></i>People You Care For</li>
            <li id="sidelink10" onclick="SidebarChildDecide(this.id)" ><i class="fa fa-envelope-o"></i>Invire Friends and Family</li>
            <li id="sidelink11" onclick="SidebarChildDecide(this.id)" ><i class="fa fa-question-circle"></i>Help and Support</li>
