...
<div class="box-layout">
    <div class="col-xs-12" style="height:60px; background-color:#336799;">
    </div>
    <div class="col-xs-12 no-padd relative">
        <img src="~/Content/Images/Website/About_02.jpg" class="col-xs-12 no-padd"/>
            <div class="caption">
                <div class="col-sm-5">
                    <h1 style=" color: #03BAF7;" class="bold">The Physician</h1>
                </div>
                <div class="col-sm-7">
                    <p class="fwhite _17">
                        We understand the need in finding trusted medical care,which is why the patient journey
    ...
    <div class="col-xs-12 no-padd bgwhite" style="padding-bottom: 100px;">
        <div class="col-xs-12 padd-50">
            <h1 class="text-center titleh1" style="font-size: 55px; font-weight: bolder;"><text style="color: #3AAF48; ">PHYSICIANS</text> <text class="custom-fblue">EXPAND YOUR PRACTICE</text></h1>
            <p class="_15">Physicians around the globe understand that patient experience is the #1 priority in healthcare today. As a physician
            you want to ensure that your patients top notch healthcare in an easily accessible environment with trusted, trained and meticulous
            nurses concierge staff. Doctourz goes above and beyond for your patients, we are with you every step of the way.</p>
        </div>
    ...
    <div class="col-xs-12 no-padd relative">
        ...
        <div class="caption">            
            ...
            <div class="col-sm-5">
                <h1 style=" color: #A94B25;" class="bold">The Lifestyle</h1>
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 no-padd bgwhite" style="padding-bottom: 100px;">
        <div class="col-xs-12 padd-50 top-20">
            <h1 class="text-center custom-blue titleh1" style="font-size: 55px; font-weight: bolder;">BUILDS <text style="color: #3AAF48; ">TRUST </text> <text class="custom-fblue"> BEFORE YOU GO ON YOUR MEDICAL JOURNEY</text></h1>
            <p class="_15">
                ...
                of the way and schedule online consults with your chosen physician without having to wait in the line.
            </p>
        </div>
    ...
    <div class="col-xs-12 no-padd relative">
        ...
        <div class="caption ">
            <div class="col-sm-6">
                <h1 style=" color: #FBF366;" class="bold">Cultural Affinity</h1>
            </div>
            <div class="col-sm-6">
                <p class="fwhite">
                    Whether you are looking for a physician in your own country or globally, our physicians understand unique cultural needs.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 no-padd bgwhite" style="padding-bottom: 100px;background-image: url(../../Content/Images/Website/heartbeat.png);background-position:center;background-repeat: repeat-x">
        <div class="col-xs-12 padd-50 top-20">
            <h1 class="text-center custom-fblue titleh1" style="font-size: 55px; font-weight: bolder;">THE <text style="color: #3AAF48; ">FOUNDERS </text> <text class="custom-fblue"></text></h1>
        </div>

        <div class="col-xs-12">
            <div class="col-sm-7 top-100">
                <p class="_17">
            ...
            <div class="col-sm-5">
                <img src="~/Content/Images/Website/about_img4.png" class="col-xs-12 no-padd" />
            </div>
        </div>
    </div>
